...
const CATEGORIES_FR: TarifCategory[] = [
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Balayage', price: '42 €' },
      ...
      { kind: 'row', name: 'Lissage brésilien', sub: 'All-in', price: '169 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Massage corps en duo avec maman ou papa', dur: '30 min', price: '55 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Manucure spa', sub: 'Gommage + massage + masque', price: '35 €' },
      { kind: 'row', name: 'Paraffine — mains sèches', price: '19 €' },
      { kind: 'row', name: 'Pédicure médicale complète, avec vernis', price: '33 €' },
      { kind: 'row', name: 'Pédicure spa', sub: 'Gommage + massage + masque', price: '45 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Vernis semi-permanent', price: '22 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Hydradermie Jeunesse', sub: 'La star · hydratation intensive', dur: '60 min', price: '75 €' },
      ...
      { kind: 'row', name: 'Soin Âge Summum', sub: 'Anti-âge longévité · rides, fermeté, taches', dur: '1h15', price: '99 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: '1 personne', dur: '2h30', price: '175 €' },
      { kind: 'row', name: '2 personnes', dur: '2h30', price: '195 €' },
    ],
  },
  {
    id: 'decouverte',
    ...
    items: [
      ...
      { kind: 'row', name: 'Gommage + massage + soin visage', dur: '2h00', price: '115 €' },
    ],
  },
  {
    id: 'permanent',
    ...
    items: [
      { kind: 'row', name: 'Sourcils — poils à poils', price: '280 €' },
      ...
      { kind: 'row', name: 'Lèvres — contour simple', price: '280 €' },
...
const CATEGORIES_NL: TarifCategory[] = [
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Braziliaanse uitgroei', sub: 'All-in', price: '169 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Lichaamsmassage in duo met mama of papa', dur: '30 min', price: '55 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Spa-manicure', sub: 'Scrub + massage + masker', price: '35 €' },
      { kind: 'row', name: 'Paraffine — droge handen', price: '19 €' },
      { kind: 'row', name: 'Volledige medische pédicure, met lak', price: '33 €' },
      { kind: 'row', name: 'Spa-pédicure', sub: 'Scrub + massage + masker', price: '45 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Semi-permanent lak', price: '22 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: 'Hydradermie Jeunesse', sub: 'De ster · intensieve hydratatie', dur: '60 min', price: '75 €' },
      ...
      { kind: 'row', name: 'Soin Âge Summum', sub: 'Anti-aging · rimpels, stevigheid, vlekken', dur: '1h15', price: '99 €' },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'row', name: '1 persoon', dur: '2u30', price: '175 €' },
      { kind: 'row', name: '2 personen', dur: '2u30', price: '195 €' },
    ],
  },
  {
    id: 'decouverte',
    ...
    items: [
      ...
      { kind: 'row', name: 'Scrub + massage + gezichtsbehandeling', dur: '2u00', price: '115 €' },
    ],
  },
  {
    id: 'permanent',
    ...
    items: [
      { kind: 'row', name: 'Wenkbrauwen — haar voor haar', price: '280 €' },
      ...
      { kind: 'row', name: 'Lippen — eenvoudig contour', price: '280 €' },
