...
const DICT = {
  fr: {
    ...
    book_lede: "Appelez-nous pendant les heures d'ouverture ou écrivez-nous via Messenger — nous répondons dans les meilleurs délais.",
  ...
  nl: {
    ...
    book_lede: 'Bel ons tijdens de openingsuren of schrijf ons via Messenger — we antwoorden zo snel mogelijk.',
